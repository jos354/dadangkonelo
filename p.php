...
ulang:
// function change(){
echo color("red","                    Killer Jos\n");
echo color("white","           Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("white","                    Vocher Gofood         \n");
echo color("white","                  Format Kode 62*** \n");
	...
	gocar:
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"RAMADHAN60"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","Message: ".$message);
        goto gofood;
        ...
        sleep(3);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"RAMADHAN60"}');
